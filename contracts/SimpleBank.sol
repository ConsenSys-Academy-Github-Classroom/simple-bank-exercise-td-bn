...
contract SimpleBank {
    ...
    function getBalance() public view returns (uint) {
      ...
      // 2. Get the balances of the sender of this transaction
    ...
    /// @return The balances of the user after the deposit is made
    function deposit() public payable returns (uint) {
      ...
      // 3. Add the amount to the user's balances. Hint: the amount can be
      ...
      // 5. return the balances of sndr of this transaction
      return balances[msg.sender];
    }
    ...
    /// @return The balances remaining for the user
    function withdraw(uint withdrawAmount) public returns (uint) {
      // If the sender's balances is at least the amount they want to withdraw,
      // Subtract the amount from the sender's balances, and try to send that amount of ether
